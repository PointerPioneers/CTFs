...
![screenshot from original Aurebesh font file](/original-aurebesh.png)

Afterwards,parts of the flag cab be retrieved from these 2 lines in 8 given font files and reassembled to get shctf{th3r3_1s_always_s0me_h0p3_4r0und}.
